...
var date = /** @class */ (function () {
    ...
    Object.defineProperty(date.prototype, "day", {
        ...
        set: function (day) {
            if ((this._month == 1 || this._month == 3 || this._month == 5 || this._month == 7 || this._month == 8 || this._month == 10 || this._month == 12) && day == 31) {
                this._day = day;
            }
            else if ((this._month == 4 || this._month == 6 || this._month == 9 || this._month == 11) && day == 30) {
                this._day = day;
            }
            else if ((this._month == 2) && (day == 28 || day == 29)) {
                this._day = day;
            }
            else {
